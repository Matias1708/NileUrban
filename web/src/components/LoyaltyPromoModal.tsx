...
import { LOYALTY_CYCLE_DAYS, LOYALTY_POINTS_PER_CUT, formatPoints } from "@/lib/loyalty-logic";
      ...
      <div className="loyalty-promo-bar-inner loyalty-promo-bar-inner--simple">
        <div className="loyalty-promo-bar-copy">
          ...
          <p className="loyalty-promo-bar-sub">
            1 corte = {formatPoints(LOYALTY_POINTS_PER_CUT)} · corte gratis a los 8 puntos · renueva cada{" "}
